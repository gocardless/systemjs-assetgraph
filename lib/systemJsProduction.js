...
function systemJsBuildHtml(assetGraph, initialAsset, options) {
  return extractSystemJsCalls(assetGraph, initialAsset)
    .then(function(systemJs) {
      ...
      var builderConfig = _.merge({ config: config }, options.builderConfig || {});
      ...
      var transpiler = options.transpiler || 'traceur';
      delete options.transpiler;
      builder.loader.transpiler = transpiler;
      ...
      return strategy(systemJs.main, builderConfig, sourceRoot, options.outRoot)
        .then(function(config) {
          ...
          var configString = 'System.transpiler = "' + transpiler + '";';
